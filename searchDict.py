...
with open("./out/2024-foundLinks.txt", "w") as f:
    f.write("")

# writing all user defined threee letter words on the start or end of the link
with open("./out/2024-foundLinks.txt", "a+") as f:
...
# writing all user defined three letter words at the start or and of the link
with open("./out/2024-foundLinks.txt", "a+") as f:
...
# writing all user defined four letter words anywhere in the link
with open("./out/2024-foundLinks.txt", "a+") as f:
    f.write(f"\four letter word anywhere\n")
i = 0
for link in list(set(links)):
    code = link[-12:]
    start = code[:3]
    ...
    codeWithoutDash = code.replace("-", "")

    for word1 in list(set(customFourWords)):
        if word1 in codeWithoutDash:
            i += 1
            with open("./out/2024-foundLinks.txt", "a+") as f:
                f.write(f"{link} -- four letter word anywhere\n")
print(f"{i} four letter word anywhere")
